            ...
            <div className="container">
                ...
                <div className="extra__info_container">
                    <div className="extra_info_text">
                        ...
                        <p>Саме для вас. Так, без перебільшення, платформа розроблялась для людей, які цікавляться інвестуванням.</p>
                        <p>Це можуть бути новачки та профі зі значними кейсами. 

                            <span>Інвестувати може кожен!</span></p> 
                            <p>На даному етапі йде пошук інвестицій для масштабування проекту та виведення його на глобальний рівень.</p>
